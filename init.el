...
(doom! :input
       ...
       :emacs
       (dired +dirvish +icons)   ; a modern file manager with previews
       ...
       (org +roam +pretty +dragndrop +journal +noter +present +pandoc +gnuplot)               ; organize your plain life in plain text
